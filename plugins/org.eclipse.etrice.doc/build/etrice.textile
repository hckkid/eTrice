...
Open the _eTrice_ tab and select _eTrice Java ModelLib_

Press _Next_ and _Finish_ to install the Modellib into your workspace.

!images/013-SetupWorkspace03.png!

Do the same steps for _eTrice Java Runtime_ and _eTrice Java Tutorials_. The resulting workspace should look like this:
