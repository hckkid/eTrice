		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getProtocolClassAccess().getGroup_17(), "rule__ProtocolClass__Group_17__0");
					...
					put(grammarAccess.getProtocolClassAccess().getIncomingMessagesAssignment_10(), "rule__ProtocolClass__IncomingMessagesAssignment_10");
					put(grammarAccess.getProtocolClassAccess().getOutgoingMessagesAssignment_14(), "rule__ProtocolClass__OutgoingMessagesAssignment_14");
					put(grammarAccess.getProtocolClassAccess().getRegularAssignment_16_2(), "rule__ProtocolClass__RegularAssignment_16_2");
					put(grammarAccess.getProtocolClassAccess().getConjugateAssignment_17_2(), "rule__ProtocolClass__ConjugateAssignment_17_2");
					put(grammarAccess.getProtocolClassAccess().getSemanticsAssignment_18(), "rule__ProtocolClass__SemanticsAssignment_18");
