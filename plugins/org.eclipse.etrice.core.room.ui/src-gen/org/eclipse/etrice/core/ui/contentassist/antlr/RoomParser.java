		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getLogicalThreadAccess().getGroup_2(), "rule__LogicalThread__Group_2__0");
					put(grammarAccess.getLogicalThreadAccess().getGroup_5(), "rule__LogicalThread__Group_5__0");
					...
					put(grammarAccess.getLogicalThreadAccess().getPrioAssignment_2_2(), "rule__LogicalThread__PrioAssignment_2_2");
					put(grammarAccess.getLogicalThreadAccess().getInstancesAssignment_4(), "rule__LogicalThread__InstancesAssignment_4");
					put(grammarAccess.getLogicalThreadAccess().getInstancesAssignment_5_1(), "rule__LogicalThread__InstancesAssignment_5_1");
