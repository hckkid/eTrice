...
public class ProtocolClassGen extends GenericProtocolClassGenerator {
  ...
  public StringConcatenation generateSourceFile(final Root root, final ProtocolClass pc) {
    ...
    _builder.newLineIfNotEmpty();
    _builder.newLine();
    _builder.append("static void sendMessage(const etPort* self, etInt16 evtId) {");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("msg->evtID = evtId;");
    _builder.newLine();
    _builder.append("\t");
    ...
    StringConcatenation _xblockexpression = null;
    {
      ...
      StringConcatenation _builder = new StringConcatenation();
      {
        for(final Message message : messages) {
          ...
          _builder.newLine();
          _builder.append("\t\t");
          _builder.append("sendMessage(self, ");
          ...
          _builder.newLine();
          _builder.append("\t\t");
          _builder.append("sendMessage((etPort*)(&self->ports[i]), ");
          ...
          _builder.newLine();
          _builder.append("\t\t");
          _builder.append("sendMessage((etPort*)(&self->ports[idx]), ");
